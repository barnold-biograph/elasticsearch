...
public class OrdinalDistinctByOperatorTests extends OperatorTestCase {
    ...
    @Override
    protected DistinctByOperator.OrdinalFactory simple(SimpleOptions options) {
        return new DistinctByOperator.OrdinalFactory(0);
    }
    ...
    protected Matcher<String> expectedDescriptionOfSimple() {
        return equalTo("DistinctByOperator[keyChannel=0, type=ORDINAL]");
    }

    @Override
    protected Matcher<String> expectedToStringOfSimple() {
        return equalTo("DistinctByOperator[keyChannel=0, OrdinalDedupProcessor]");
    }
    ...
    private DistinctByOperator ordinal(int keyChannel) {
        return (DistinctByOperator) new DistinctByOperator.OrdinalFactory(keyChannel).get(driverContext());
    }

    private DistinctByOperator ordinal(int keyChannel, boolean failOnDuplicate) {
        return (DistinctByOperator) new DistinctByOperator.OrdinalFactory(keyChannel, failOnDuplicate).get(driverContext());
    }
